...
|---|---|---|---|
| 1 | **Teste dos 5 segundos** | proxy: todo `.step` tem um visual (`.tela`, `.lado`, `.janela`, `figure`, `.diag`) — confirmar com o leitor simulado | 100% dos steps |
| 2 | **Mostrar, não simbolizar** | ≥2 visuais reais (`.tela`/`.lado`/`.janela`) + `figure.cena` com alt >20 caracteres e ≤150 KB | sim |
...
| 8 | **Zero jargão e zero "à direita"** | lista-sentinela no texto e nos cartões; "à direita/esquerda" (no celular os cartões empilham) | 0 |
